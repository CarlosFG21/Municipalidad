...
<div class="modal fade" id="modaleliminarempleado<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Eliminar empleado</h5>
            ...
            <div class="modal-body">
                <form role="form" method="post" action="../crud/eliminarEmpleado.php">
                    
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Fecha de egreso</label>
                        <input type="date" class="form-control" placeholder="Ingrese la fecha a egresar" id="fecham" name="fecham" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <input type="submit" value="Eliminar" class="btn btn-danger" name="btnEliminarE" id="btnEliminarE">
