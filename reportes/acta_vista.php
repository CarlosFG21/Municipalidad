...
<?php
    ...
    $pdf->Ln(10);
    $pdf->SetFont('Arial','',12);
    $pdf->MultiCell(177,6, utf8_decode('Apetición de la dirección DAFIM se extiende el siguiente documento el cual contiene vigencia durante todo el proceso laboral del empleado, indicando de esta forma la observacion que se efectúo en dicho momento para la contencion y reguardo del historial observatico que contiene el empleado en base a sus actividades y cambios efectuados') ,0,'J');
    $pdf->Ln(50);
